...
public class News extends AppCompatActivity implements CategoryRVAdaptor.CategorClickInterface {
...
//        getSupportActionBar().hide();
    ...
    private void getCategories() {
        categoryRVModalArrayList.add(new CategoryRVModal("All", "https://media.istockphoto.com/photos/rendering-background-picture-id1336346717?s=612x612"));
    ...
    private void getNews(String category) {
        ...
        call.enqueue(new Callback<NewsModal>() {
            ...
            public void onFailure(Call<NewsModal> call, Throwable t) {
                Toast.makeText(News.this, "FAIL TO GET NEWS", Toast.LENGTH_SHORT).show();
